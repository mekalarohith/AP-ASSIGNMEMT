...
public class SportsPreparing {
	...
	public static ArrayList<Athlete> creatAllAthletes() {
		Athlete ath1 = new Athlete("A-1", "Bhanu     ", 31, "TAS", "Swimming");
		Athlete ath2 = new Athlete("A-2", "Rohith   ", 28, "WA ", "Swimming");
		Athlete ath3 = new Athlete("A-3", "Ashwin    ", 28, "QLD", "Swimming");
		Athlete ath4 = new Athlete("A-4", "Harsha ", 29, "NT ", "Swimming");
		Athlete ath5 = new Athlete("A-5", "Akhil   ", 25, "QLD", "Swimming");
		Athlete ath6 = new Athlete("A-6", "Dileep    ", 26, "NSW", "Swimming");
		Athlete ath7 = new Athlete("A-7", "Karthik    ", 23, "VIC", "Running");
		Athlete ath8 = new Athlete("A-8", "Samantha  ", 24, "TAS", "Running");
		Athlete ath9 = new Athlete("A-9", "Kajal ", 27, "QLD", "Running");
		Athlete ath10 = new Athlete("A10", "NTR    ", 23, "WA ", "Running");
		Athlete ath11 = new Athlete("A-11", "Mahesh Babu     ", 27, "NT ", "Running");
		Athlete ath12 = new Athlete("A-12", "Ram Charan    ", 29, "VIC", "Running");
		Athlete ath13 = new Athlete("A-13", "Mega Star Chiru", 27, "QLD", "Cycling");
		Athlete ath14 = new Athlete("A-14", "Suresh Raina ", 22, "TAS", "Cycling");
		Athlete ath15 = new Athlete("A-15", "Rohith Sharma ", 26, "SA ", "Cycling");
		Athlete ath16 = new Athlete("A-16", "MS DHONI ", 26, "VIC", "Cycling");
		Athlete ath17 = new Athlete("A-17", "Virat Kohili ", 25, "SA ", "Cycling");
		Athlete ath18 = new Athlete("A-18", "Catherine teresa", 25, "NSW", "Cycling");
		Athlete ath19 = new Athlete("A-19", "Bujji ", 25, "TAS", "SuperAthlete");
		Athlete ath20 = new Athlete("A-20", "Pawan Kalyan  ", 28, "SA ", "SuperAthlete");
		Athlete ath21 = new Athlete("A-21", "Sachin Tendulkar   ", 24, "VIC", "SuperAthlete");
		Athlete ath22 = new Athlete("A-22", "Sikhar Dhawan", 25, "NSW", "SuperAthlete");
		Athlete ath23 = new Athlete("A-23", "Yuvraj", 26, "VIC", "SuperAthlete");
		Athlete ath24 = new Athlete("A-24", "Bumrah   ", 30, "TAS", "SuperAthlete");
